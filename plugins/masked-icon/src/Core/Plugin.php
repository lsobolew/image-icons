...
final class Plugin {
	 ...
	 *
	 * Public on purpose: this is how Pro edition modules join in on `maskedicon_register_modules`.
	 *
	...
	public function boot(): void {
		 ...
		 */
		$classes = apply_filters( 'maskedicon_modules', $this->module_classes() );
		 ...
		 */
		do_action( 'maskedicon_register_modules', $this );
		 ...
		 * @param Plugin $plugin Plugin instance.
		 */
		do_action( 'maskedicon_loaded', $this );
	}
	...
	private function module_classes(): array {
		$file = MASKED_ICON_DIR . 'config/modules.php';

...
final class Upgrader {
	...
	public static function maybe_upgrade(): void {
		...
		if ( version_compare( $stored, MASKED_ICON_VERSION, '>=' ) ) {
			return;
		}
		...
		update_option( Activator::VERSION_OPTION, MASKED_ICON_VERSION );
		 ...
		 */
		do_action( 'maskedicon_upgraded', $stored, MASKED_ICON_VERSION );
	}

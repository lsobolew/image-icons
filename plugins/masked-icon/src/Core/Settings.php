...
final class Settings {
	 ...
	 */
	const OPTION = 'masked_icon_settings';

	/**
	 * Settings group for the Settings API.
	 */
	const GROUP = 'masked_icon_settings_group';
	...
	public static function sanitize( $input ): array {
		 ...
		 */
		return apply_filters( 'maskedicon_settings_sanitize', $clean, $input );
	}
}

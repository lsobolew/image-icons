...
const TONE_OPTIONS: ToneOption[] = [
	{ label: __( 'Information', 'masked-icon' ), value: 'info' },
	{ label: __( 'Warning', 'masked-icon' ), value: 'warning' },
];
...
export default function Edit( { attributes, setAttributes }: CalloutEditProps ) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={ __( 'Callout settings', 'masked-icon' ) }>
					<SelectControl
			...
			<div { ...blockProps }>
				<RichText
					...
					placeholder={ __( 'Write your callout here…', 'masked-icon' ) }
				/>
			</div>
		</>
	);

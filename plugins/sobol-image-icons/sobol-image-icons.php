<?php
/**
 * Plugin Name:       Sobol Image Icons
 * Plugin URI:        https://github.com/lsobolew/sobol-image-icons
...
define( 'SOBOL_IMAGE_ICONS_DIR', plugin_dir_path( __FILE__ ) );
define( 'SOBOL_IMAGE_ICONS_URL', plugin_dir_url( __FILE__ ) );
define( 'SOBOL_IMAGE_ICONS_BASENAME', plugin_basename( __FILE__ ) );
...
// needs a chance to hook `sobolimageicons_register_modules` before it fires.
add_action(
	'plugins_loaded',
	static function () {

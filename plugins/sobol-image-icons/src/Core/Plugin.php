 ...
 *
 * The filter and the `sobolimageicons_register_modules` action are the extension surface - an add-on
...
final class Plugin {
	...
	public function version(): string {
		return SOBOL_IMAGE_ICONS_VERSION;
	}
	 ...
	 *
	 * Public on purpose: this is how an add-on joins in on `sobolimageicons_register_modules`.
	 *
	...
	public function boot(): void {
		 ...
		 */
		$classes = apply_filters( 'sobolimageicons_modules', $this->module_classes() );
		 ...
		 */
		do_action( 'sobolimageicons_register_modules', $this );
		 ...
		 * @param Plugin $plugin Plugin instance.
		 */
		do_action( 'sobolimageicons_loaded', $this );
	}
	...
	private function module_classes(): array {
		$file = SOBOL_IMAGE_ICONS_DIR . 'config/modules.php';

...
final class KsesCompatibilityTest extends WP_UnitTestCase {
	 ...
	 */
	private const ICON_MARKUP = '<!-- wp:sobol-image-icons/icon {"url":"https://example.com/arrow.png","size":"1.5em","label":"Next"} -->' .
		'<div class="wp-block-sobol-image-icons-icon"><span class="wp-block-sobol-image-icons-icon__mark" style="--sobol-image-icons-image:url(https://example.com/arrow.png);--sobol-image-icons-size:1.5em" role="img" aria-label="Next"></span></div>' .
		'<!-- /wp:sobol-image-icons/icon -->';
	...
	private const BUTTON_MARKUP = '<!-- wp:buttons --><div class="wp-block-buttons">' .
		'<!-- wp:button {"sobolImageIconsUrl":"https://example.com/arrow.png"} -->' .
		'<div class="wp-block-button has-sobol-image-icons is-icon-after" style="--sobol-image-icons-image:url(https://example.com/arrow.png);--sobol-image-icons-size:1em;--sobol-image-icons-gap:0.5em">' .
	...
	private const INLINE_MARKUP = '<!-- wp:paragraph -->' .
		'<p>Read more <img class="wp-block-sobol-image-icons-icon__inline" src="https://example.com/arrow.png" ' .
		'alt="" style="--sobol-image-icons-image:url(https://example.com/arrow.png)"> and then some</p>' .
		'<!-- /wp:paragraph -->';
	...
	public static function markup_provider(): array {
		return array(
			...
			'inline icon with a palette colour'   => array(
				...
				'class="wp-block-sobol-image-icons-icon__inline has-accent-3-color has-text-color" ' .
				'src="https://example.com/arrow.png" alt="Next" ' .
				'style="--sobol-image-icons-image:url(https://example.com/arrow.png);--sobol-image-icons-size:1.5em"> here</p>' .
				'<!-- /wp:paragraph -->',
			),
			'inline icon with a custom colour'    => array(
				'<!-- wp:paragraph --><p>Read more <img ' .
				'class="wp-block-sobol-image-icons-icon__inline has-text-color" ' .
				'src="https://example.com/arrow.png" alt="" ' .
				'style="--sobol-image-icons-image:url(https://example.com/arrow.png);color:#d00000"> here</p>' .
				'<!-- /wp:paragraph -->',
			),
			'inline icon keeping its own colours' => array(
				'<!-- wp:paragraph --><p>Our <img ' .
				'class="wp-block-sobol-image-icons-icon__inline is-original" ' .
				'src="https://example.com/logo.png" alt="Logo" ' .
				'style="--sobol-image-icons-image:url(https://example.com/logo.png)"> logo</p>' .
				'<!-- /wp:paragraph -->',
			),
			'icon block'                          => array( self::ICON_MARKUP ),
			'button with icon'                    => array( self::BUTTON_MARKUP ),
			'decorative icon'                     => array(
				'<!-- wp:sobol-image-icons/icon {"url":"https://example.com/star.svg"} -->' .
				'<div class="wp-block-sobol-image-icons-icon"><span class="wp-block-sobol-image-icons-icon__mark" style="--sobol-image-icons-image:url(https://example.com/star.svg);--sobol-image-icons-size:1em" aria-hidden="true"></span></div>' .
				'<!-- /wp:sobol-image-icons/icon -->',
			),
		);
	}
	...
	public function test_a_direct_mask_declaration_would_not_survive(): void {
		$safe   = '<span style="--sobol-image-icons-image:url(https://example.com/a.png)"></span>';

...
export function readSettings( attributes: Record< string, string > ): IconSettings {
	...
	return {
		...
		size: declarations.get( '--sobol-image-icons-size' ) || '',
		align: declarations.get( '--sobol-image-icons-align' ) || '',
...
export function writeSettings(
	...
	declarations.set( '--sobol-image-icons-image', `url(${ encodeURI( settings.src ) })` );
	declarations.set( '--sobol-image-icons-size', settings.size );
	declarations.set( '--sobol-image-icons-align', settings.align );

	...
	return (
		<>
			<BlockControls>
				...
				>
					{ __( 'Remove image', 'sobol-image-icons' ) }
				</ToolbarButton>
			</BlockControls>

			<InspectorControls>
				<PanelBody title={ __( 'Icon', 'sobol-image-icons' ) }>
					<UnitControl
					...
					{ ! original && (
						<BaseControl
							...
							id="sobol-image-icons-block-colour"
					...
					<TextControl
						label={ __( 'Link', 'sobol-image-icons' ) }
						type="url"
						value={ href }
					...
					{ Boolean( href ) && (
						<ToggleControl
							label={ __( 'Open in a new tab', 'sobol-image-icons' ) }

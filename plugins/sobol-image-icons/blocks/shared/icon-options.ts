...
export const ALIGN_OPTIONS: SelectOption[] = [
	{ label: __( 'Middle', 'sobol-image-icons' ), value: 'middle' },
	{ label: __( 'Text bottom', 'sobol-image-icons' ), value: 'text-bottom' },
	{ label: __( 'Text top', 'sobol-image-icons' ), value: 'text-top' },
];
...
export const HOVER_ANIMATION_OPTIONS: SelectOption[] = [
	{ label: __( 'None', 'sobol-image-icons' ), value: '' },
	{ label: __( 'Slide', 'sobol-image-icons' ), value: 'slide' },
	{ label: __( 'Rotate', 'sobol-image-icons' ), value: 'rotate' },
	{ label: __( 'Spin', 'sobol-image-icons' ), value: 'spin' },
	{ label: __( 'Grow', 'sobol-image-icons' ), value: 'grow' },
	{ label: __( 'Bounce', 'sobol-image-icons' ), value: 'bounce' },
	{ label: __( 'Wiggle', 'sobol-image-icons' ), value: 'wiggle' },
];
...
export const IDLE_ANIMATION_OPTIONS: SelectOption[] = [
	...
	{ label: __( 'Bounce', 'sobol-image-icons' ), value: 'bounce' },
	{ label: __( 'Wiggle', 'sobol-image-icons' ), value: 'wiggle' },
	{ label: __( 'Pulse', 'sobol-image-icons' ), value: 'pulse' },
	{ label: __( 'Spin', 'sobol-image-icons' ), value: 'spin' },
];

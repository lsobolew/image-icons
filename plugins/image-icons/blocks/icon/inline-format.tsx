...
function IconSettingsPopover( {
	...
	return (
		<Popover
			...
			focusOnMount={ false }
			placement="bottom"
			className="image-icons-inline-settings"
		>
			<div className="image-icons-inline-settings__body">
				<MediaUploadCheck>
					<MediaUpload
						allowedTypes={ [ 'image' ] }
				...
				<SelectControl
					label={ __( 'Alignment', 'image-icons' ) }
					help={ __( 'How the icon sits against the text.', 'image-icons' ) }

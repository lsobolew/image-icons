...
final class Settings {
	 ...
	 */
	const OPTION = 'image_icons_settings';

	/**
	 * Settings group for the Settings API.
	 */
	const GROUP = 'image_icons_settings_group';
	...
	public static function sanitize( $input ): array {
		 ...
		 */
		return apply_filters( 'imageicons_settings_sanitize', $clean, $input );
	}
}
